...
import { Flower, Sprout, Heart, Flame, Home, Building, ExternalLink, ChevronRight, Gift, Baby, Sparkles, Leaf, Palette, Handshake, Calendar, MapPin, Truck, Store, Candle, Clock, Sparkles as SparklesIcon, Users, RefreshCw } from 'lucide-react';
        ...
        <main className="bg-cream-50 min-h-screen">
            ...
            <div className="container mx-auto px-4 max-w-4xl">
              ...
              <div className="mt-8 text-center">
                <p className="text-sage-600 mb-4">
                  Découvrez nos créations par occasion : <Link to="/creations-florales" className="text-poppy-600 hover:text-poppy-700 font-medium underline">Mariage</Link>, 
                  {' '}<Link to="/evenements#anniversaire" className="text-poppy-600 hover:text-poppy-700 font-medium underline">Anniversaire</Link>, 
                  {' '}<Link to="/evenements#bapteme" className="text-poppy-600 hover:text-poppy-700 font-medium underline">Baptême</Link>, 
                  {' '}<Link to="/deuil" className="text-poppy-600 hover:text-poppy-700 font-medium underline">Deuil</Link> et bien plus.
                </p>
              </div>
            </div>
          </motion.section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_450px] gap-8 lg:gap-12 max-w-7xl mx-auto">
              ...
              >
                ...
                >
                  <motion.div
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="w-20 h-20 bg-gradient-to-br from-poppy-100 to-poppy-200 rounded-2xl flex items-center justify-center shadow-lg hover:shadow-xl transition-shadow duration-300"
                  >
                    <Flower className="text-poppy-600" size={36} />
                  </motion.div>
                  <motion.h2 
                ...
                >
                  <motion.div 
                    className="absolute top-0 right-0 w-64 h-64 bg-poppy-100 rounded-full -mr-32 -mt-32 opacity-20"
                    animate={{ 
                      scale: [1, 1.1, 1],
                      rotate: [0, 5, 0]
                    }}
                  ...
                  <div className="relative z-10">
                    <p className="text-lg text-sage-700 leading-relaxed mb-6">
                      Bouquet Nantes : Chez Au Vertige, artisan fleuriste à Nantes Sud, nous créons des <strong className="text-poppy-600">bouquets sur-mesure</strong> pour toutes vos occasions : 
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
                      <div className="flex items-start gap-3">
                        <Flower className="w-6 h-6 text-poppy-600 mt-0.5 flex-shrink-0" />
                        <div>
                      ...
                      <div className="flex items-start gap-3">
                        <Store className="w-6 h-6 text-poppy-600 mt-0.5 flex-shrink-0" />
                        <div>
                      ...
                      <div className="flex items-start gap-3">
                        <Calendar className="w-6 h-6 text-poppy-600 mt-0.5 flex-shrink-0" />
                        <div>
                      ...
                      <div className="flex items-start gap-3">
                        <Palette className="w-6 h-6 text-poppy-600 mt-0.5 flex-shrink-0" />
                        <div>
                ...
                >
                  ...
                  >
                    <Button
                      ...
                      className="bg-gradient-to-r from-poppy-500 to-poppy-600 hover:from-poppy-600 hover:to-poppy-700 text-white font-bold py-4 px-10 rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 text-lg group relative overflow-hidden"
                    >
                      ...
                      <motion.div
                        className="absolute inset-0 bg-gradient-to-r from-poppy-600 to-poppy-700 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                        initial={false}
                      />
                    </Button>
                  </motion.div>
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="bg-gradient-to-br from-sage-50 to-cream-50 rounded-2xl p-6 mb-6 border border-sage-200">
                      ...
                      <a
                        ...
                        className="inline-flex items-center gap-2 text-poppy-600 hover:text-poppy-700 font-medium transition-colors"
                      >
                ...
                >
                  ...
                  >
                    <Button
                      ...
                      className="bg-gradient-to-r from-poppy-500 to-poppy-600 hover:from-poppy-600 hover:to-poppy-700 text-white font-bold py-4 px-10 rounded-full shadow-xl transition text-lg group"
                    >
                      Demander un devis
              ...
              >
                ...
                >
                  ...
                  <div className="relative z-10">
                    <p className="text-lg text-sage-700 leading-relaxed mb-6">
                      Depuis <strong className="text-poppy-600">plus de 10 ans</strong>, nous accompagnons les familles dans les moments difficiles pour 
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
                      ...
                      <div className="flex items-start gap-3">
                        <MapPin className="w-6 h-6 text-poppy-600 mt-0.5 flex-shrink-0" />
                        <div>
                      ...
                      <div className="flex items-start gap-3">
                        <Clock className="w-6 h-6 text-poppy-600 mt-0.5 flex-shrink-0" />
                        <div>
                      ...
                      <div className="flex items-start gap-3">
                        <Heart className="w-6 h-6 text-poppy-600 mt-0.5 flex-shrink-0" />
                        <div>
              ...
              >
                <div className="flex items-center gap-4 mb-8">
                  <motion.div
                    whileHover={{ scale: 1.1, rotate: -5 }}
                    className="w-20 h-20 bg-gradient-to-br from-poppy-100 to-poppy-200 rounded-2xl flex items-center justify-center shadow-lg"
                  >
                    <Flame className="text-poppy-600" size={36} />
                  </motion.div>
                  <h2 className="text-4xl md:text-5xl font-dancing text-sage-700">
                ...
                >
                  ...
                  <div className="relative z-10">
                    <p className="text-lg text-sage-700 leading-relaxed mb-6">
                      Chez Au Vertige, on aime trouver des <strong className="text-poppy-600">cadeaux originaux</strong> qui sortent de l'ordinaire. 
                      C'est pour ça qu'on vous propose une sélection de <strong className="text-poppy-600">bougies parfumées et diffuseurs d'ambiance</strong> 
                    ...
                    <div className="bg-gradient-to-br from-poppy-50 to-cream-50 rounded-2xl p-6 mb-6 border border-poppy-200">
                      <h3 className="text-xl font-semibold text-sage-700 mb-3 flex items-center gap-2">
                        <Handshake className="h-6 w-6 text-poppy-600" />
              ...
              >
                ...
                <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12 mb-8 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-lg text-sage-700 leading-relaxed mb-6">
                      Nous travaillons avec différents éléments : <strong className="text-poppy-600">fleurs séchées</strong> pour des compositions durables, 
                      <strong className="text-poppy-600"> cadres végétaux</strong> pour habiller vos murs, <strong className="text-poppy-600">vases sur-mesure</strong> 
                      pour mettre en valeur vos fleurs, et <strong className="text-poppy-600">bougeoirs personnalisés</strong> pour créer des ambiances chaleureuses. 
              ...
              >
                ...
                <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12 mb-8 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-lg text-sage-700 leading-relaxed mb-6">
                      Nos <strong className="text-poppy-600">abonnements floraux</strong> vous simplifient la vie : nous créons vos compositions régulièrement, 
                    ...
                    <p className="text-lg text-sage-700 leading-relaxed mb-6">
                      Pour vos <strong className="text-poppy-600">événements d'entreprise</strong> (séminaires, inaugurations, lancements de produits, conférences), 
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8 mb-8">
                      ...
                      <div className="flex items-start gap-3">
                        <Building className="w-6 h-6 text-poppy-600 mt-0.5 flex-shrink-0" />
                        <div>
                      ...
                      <div className="flex items-start gap-3">
                        <SparklesIcon className="w-6 h-6 text-poppy-600 mt-0.5 flex-shrink-0" />
                        <div>
                      ...
                      <div className="flex items-start gap-3">
                        <RefreshCw className="w-6 h-6 text-poppy-600 mt-0.5 flex-shrink-0" />
                        <div>
          ...
          {selectedImage && (
            ...
            >
              ...
              <button
                onClick={() => setSelectedImage(null)}
                className="absolute top-4 right-4 text-white text-4xl hover:text-poppy-400 transition-colors"
              >
                ×
              </button>
            </motion.div>
            ...
            >
              <form onSubmit={(e) => handleDevisSubmit(e, serviceNames[service])} className="flex flex-col gap-4">
                <div>
                  ...
                  <input type="text" className="w-full border border-sage-200 rounded-lg px-4 py-2 focus:ring-2 focus:ring-poppy-500 focus:border-transparent" required />
                </div>
                <div>
                  <label className="block text-sage-700 mb-1 font-medium">Téléphone</label>
                  <input type="tel" className="w-full border border-sage-200 rounded-lg px-4 py-2 focus:ring-2 focus:ring-poppy-500 focus:border-transparent" required />
                </div>
                <div>
                  <label className="block text-sage-700 mb-1 font-medium">Email</label>
                  <input type="email" className="w-full border border-sage-200 rounded-lg px-4 py-2 focus:ring-2 focus:ring-poppy-500 focus:border-transparent" required />
                </div>
                <div>
                  <label className="block text-sage-700 mb-1 font-medium">Message / Détails de votre demande</label>
                  <textarea className="w-full border border-sage-200 rounded-lg px-4 py-2 focus:ring-2 focus:ring-poppy-500 focus:border-transparent" rows={4} required />
                </div>
                <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                  <Button type="submit" className="w-full bg-gradient-to-r from-poppy-500 to-poppy-600 hover:from-poppy-600 hover:to-poppy-700 text-white font-bold py-3 px-6 rounded-full shadow-lg transition mt-2">
                    Envoyer la demande
                  </Button>
                </motion.div>
              </form>
