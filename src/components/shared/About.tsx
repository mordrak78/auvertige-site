        ...
        <div className="mb-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative order-2 lg:order-1 flex justify-center lg:justify-start">
              ...
              {/* Éléments décoratifs */}
              <div className="absolute -top-4 -right-4 w-24 h-24 bg-poppy-200 rounded-full opacity-60 -z-10"></div>
            ...
            <div className="order-1 lg:order-2">
              <div className="flex items-center gap-3 mb-6">
                <Crown className="text-poppy-500" size={28} />
              ...
              <div className="space-y-6 text-sage-600 leading-relaxed">
                ...
                <p>
                  ...
                  Cette double expertise lui donne une vision d'ensemble du circuit de vente horticole, qu'elle met au service de ses clients depuis maintenant <strong className="text-poppy-600">14 ans</strong> en tant qu'<strong className="text-sage-700">artisan fleuriste Nantes</strong>.
                </p>
                ...
                <p>
                  ...
                  privilégiant les <strong className="text-poppy-600">produits locaux et le circuit court nantais</strong>. Son approche unique ? Privilégier les fleurs qui sortent de l'ordinaire et créer des ambiances exceptionnelles.
                </p>
                ...
                <p>
                  ...
                  comme <a href="https://www.mathildem.com" target="_blank" rel="noopener noreferrer" className="text-poppy-600 hover:text-poppy-700 font-medium inline-flex items-center gap-1">
                ...
                <div className="mt-6 p-4 bg-sage-50 rounded-lg border border-sage-200">
                  ...
                  <a 
                    ...
                    className="text-poppy-600 hover:text-poppy-700 font-medium inline-flex items-center gap-1 text-sm"
                  >
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            ...
            <div className="flex items-center justify-center mb-6">
              ...
              <Users className="mx-4 text-poppy-500" size={20} />
              <div className="h-px bg-sage-300 w-12"></div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="space-y-4 text-sage-600 leading-relaxed">
                ...
                <p>
                  Leur particularité ? Ils ont le <strong className="text-poppy-600">goût de transmettre leurs passions</strong> aux jeunes générations. 
            ...
            <div className="relative">
              ...
              />
              <div className="absolute -top-4 -right-4 w-20 h-20 bg-poppy-200 rounded-full opacity-60 -z-10"></div>
        ...
        <div className="text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="w-12 h-12 bg-poppy-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <Heart className="text-poppy-500" size={24} />
              </div>
            ...
            <div className="p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="w-12 h-12 bg-poppy-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <Flower2 className="text-poppy-500" size={24} />
              </div>
            ...
            <div className="p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="w-12 h-12 bg-poppy-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <Users className="text-poppy-500" size={24} />
              </div>
